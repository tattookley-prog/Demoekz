...
info "[Задание 6] Чистое пересоздание GRE-туннеля gre1 (etcnet)..."
...
# Применяем немедленно с чистым пересозданием
...
ok "GRE туннель gre1 чисто пересоздан: ${GRE_TUNNEL_CIDR} → ${HQ_WAN_IP} (etcnet — постоянно)"
